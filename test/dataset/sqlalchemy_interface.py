...
class Base(DeclarativeBase):
    type_mappings = {
        Type: TypeType,
        dataset.example_classes.PhysicalObject: dataset.example_classes.ConceptType,
    }


class AlternativeMappingAggregatorDAO(
    Base, DataAccessObject[dataset.example_classes.AlternativeMappingAggregator]
):
    __tablename__ = "AlternativeMappingAggregatorDAO"

    id: Mapped[int] = mapped_column(Integer, primary_key=True)

    entities1: Mapped[List[CustomEntityDAO]] = relationship(
        "CustomEntityDAO",
        foreign_keys="[CustomEntityDAO.alternativemappingaggregatordao_entities1_id]",
        post_update=True,
    )
    entities2: Mapped[List[CustomEntityDAO]] = relationship(
        "CustomEntityDAO",
...
class BackreferenceMappingDAO(
    Base, DataAccessObject[dataset.example_classes.BackreferenceMapping]
):
    ...
    reference_id: Mapped[int] = mapped_column(
        ForeignKey("ReferenceDAO.id", use_alter=True), nullable=True
    )
...
class BodyDAO(Base, DataAccessObject[dataset.example_classes.Body]):
    ...
    worlddao_bodies_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("WorldDAO.id", use_alter=True), nullable=True
    )
...
class ParentBaseMappingDAO(
    Base, DataAccessObject[dataset.example_classes.ParentBaseMapping]
):
...
class ConnectionDAO(Base, DataAccessObject[dataset.example_classes.Connection]):
    ...
    worlddao_connections_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("WorldDAO.id", use_alter=True), nullable=True
    )
...
class ContainerDAO(Base, DataAccessObject[dataset.example_classes.Container]):
    __tablename__ = "ContainerDAO"

    id: Mapped[int] = mapped_column(Integer, primary_key=True)

    items: Mapped[List[ItemWithBackreferenceDAO]] = relationship(
        "ItemWithBackreferenceDAO",
        foreign_keys="[ItemWithBackreferenceDAO.containerdao_items_id]",
        post_update=True,
    )
...
class CustomEntityDAO(Base, DataAccessObject[dataset.example_classes.CustomEntity]):
    ...
    alternativemappingaggregatordao_entities1_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("AlternativeMappingAggregatorDAO.id", use_alter=True), nullable=True
    )
    alternativemappingaggregatordao_entities2_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("AlternativeMappingAggregatorDAO.id", use_alter=True), nullable=True
    )
...
class DoublePositionAggregatorDAO(
    Base, DataAccessObject[dataset.example_classes.DoublePositionAggregator]
):
    __tablename__ = "DoublePositionAggregatorDAO"

    id: Mapped[int] = mapped_column(Integer, primary_key=True)

    positions1: Mapped[List[PositionDAO]] = relationship(
        "PositionDAO",
        foreign_keys="[PositionDAO.doublepositionaggregatordao_positions1_id]",
        post_update=True,
    )
    positions2: Mapped[List[PositionDAO]] = relationship(
        "PositionDAO",
...
class EntityAssociationDAO(
    Base, DataAccessObject[dataset.example_classes.EntityAssociation]
):
    ...
    entity_id: Mapped[int] = mapped_column(
        ForeignKey("CustomEntityDAO.id", use_alter=True), nullable=True
    )
...
class ItemWithBackreferenceDAO(
    Base, DataAccessObject[dataset.example_classes.ItemWithBackreference]
):
    ...
    containerdao_items_id: Mapped[Optional[int]] = mapped_column(
...
class KinematicChainDAO(Base, DataAccessObject[dataset.example_classes.KinematicChain]):
    ...
    torsodao_kinematic_chains_id: Mapped[Optional[int]] = mapped_column(
...
class MoreShapesDAO(Base, DataAccessObject[dataset.example_classes.MoreShapes]):
    ...
    shapes: Mapped[List[ShapesDAO]] = relationship(
        "ShapesDAO",
...
class NodeDAO(Base, DataAccessObject[dataset.example_classes.Node]):
    ...
    parent_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("NodeDAO.id", use_alter=True), nullable=True
    )
...
class ObjectAnnotationDAO(
    Base, DataAccessObject[dataset.example_classes.ObjectAnnotation]
):
    ...
    object_reference_id: Mapped[int] = mapped_column(
        ForeignKey("OriginalSimulatedObjectDAO.id", use_alter=True), nullable=True
    )
...
class OriginalSimulatedObjectDAO(
    Base, DataAccessObject[dataset.example_classes.OriginalSimulatedObject]
):
    ...
    concept: Mapped[dataset.example_classes.ConceptType] = mapped_column(
        dataset.example_classes.ConceptType, nullable=False
    )
...
class PoseDAO(Base, DataAccessObject[dataset.example_classes.Pose]):
    ...
    position_id: Mapped[int] = mapped_column(
        ForeignKey("PositionDAO.id", use_alter=True), nullable=True
    )
    orientation_id: Mapped[int] = mapped_column(
        ForeignKey("OrientationDAO.id", use_alter=True), nullable=True
    )
...
class PositionDAO(Base, DataAccessObject[dataset.example_classes.Position]):
    ...
    doublepositionaggregatordao_positions1_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("DoublePositionAggregatorDAO.id", use_alter=True), nullable=True
    )
    doublepositionaggregatordao_positions2_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("DoublePositionAggregatorDAO.id", use_alter=True), nullable=True
    )
    positionsdao_positions_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("PositionsDAO.id", use_alter=True), nullable=True
    )
...
class PositionTypeWrapperDAO(
    Base, DataAccessObject[dataset.example_classes.PositionTypeWrapper]
):
...
class PositionsDAO(Base, DataAccessObject[dataset.example_classes.Positions]):
    ...
    positions: Mapped[List[PositionDAO]] = relationship(
        "PositionDAO",
...
class PrivateDefaultFactoryDAO(
    Base, DataAccessObject[dataset.example_classes.PrivateDefaultFactory]
):
...
class ReferenceDAO(Base, DataAccessObject[dataset.example_classes.Reference]):
    ...
    backreference_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("BackreferenceMappingDAO.id", use_alter=True), nullable=True
    )
...
class ShapeDAO(Base, DataAccessObject[dataset.example_classes.Shape]):
    ...
    origin_id: Mapped[int] = mapped_column(
        ForeignKey("TransformationMappedDAO.id", use_alter=True), nullable=True
    )
    shapesdao_shapes_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("ShapesDAO.id", use_alter=True), nullable=True
    )
...
class ShapesDAO(Base, DataAccessObject[dataset.example_classes.Shapes]):
    ...
    moreshapesdao_shapes_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("MoreShapesDAO.id", use_alter=True), nullable=True
    )
...
class TransformationMappedDAO(
    Base, DataAccessObject[dataset.example_classes.TransformationMapped]
):
    ...
    vector_id: Mapped[int] = mapped_column(
        ForeignKey("VectorMappedDAO.id", use_alter=True), nullable=True
    )
    rotation_id: Mapped[int] = mapped_column(
        ForeignKey("RotationMappedDAO.id", use_alter=True), nullable=True
    )
...
class VectorMappedDAO(Base, DataAccessObject[dataset.example_classes.VectorMapped]):
    ...
    vectorswithpropertymappeddao_vectors_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("VectorsWithPropertyMappedDAO.id", use_alter=True), nullable=True
    )


class VectorsWithPropertyMappedDAO(
    Base, DataAccessObject[dataset.example_classes.VectorsWithPropertyMapped]
):
    __tablename__ = "VectorsWithPropertyMappedDAO"

    id: Mapped[int] = mapped_column(Integer, primary_key=True)

    vectors: Mapped[List[VectorMappedDAO]] = relationship(
        "VectorMappedDAO",
...
class WorldDAO(Base, DataAccessObject[dataset.example_classes.World]):
    ...
    bodies: Mapped[List[BodyDAO]] = relationship(
...
class HandleDAO(BodyDAO, DataAccessObject[dataset.example_classes.Handle]):
...
class ContainerBodyDAO(
    BodyDAO, DataAccessObject[dataset.example_classes.ContainerBody]
):
...
class ChildBaseMappingDAO(
    ParentBaseMappingDAO, DataAccessObject[dataset.example_classes.ChildBaseMapping]
):
    __tablename__ = "ChildBaseMappingDAO"

    id: Mapped[int] = mapped_column(
        ForeignKey(ParentBaseMappingDAO.id), primary_key=True
    )
...
class PrismaticDAO(ConnectionDAO, DataAccessObject[dataset.example_classes.Prismatic]):
...
class FixedDAO(ConnectionDAO, DataAccessObject[dataset.example_classes.Fixed]):
...
class DerivedEntityDAO(
    CustomEntityDAO, DataAccessObject[dataset.example_classes.DerivedEntity]
):
...
class TorsoDAO(KinematicChainDAO, DataAccessObject[dataset.example_classes.Torso]):
    ...
    kinematic_chains: Mapped[List[KinematicChainDAO]] = relationship(
        "KinematicChainDAO",
...
class PositionsSubclassWithAnotherPositionDAO(
    PositionsDAO,
    DataAccessObject[dataset.example_classes.PositionsSubclassWithAnotherPosition],
):
...
class Position5DDAO(
    Position4DDAO, DataAccessObject[dataset.example_classes.Position5D]
):
